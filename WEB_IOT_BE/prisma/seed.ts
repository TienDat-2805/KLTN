...
async function main() {
  ...
  const factoryDevices = [
    ...
    {
      deviceUid: "HUMIDITY_ETH_001",
      devEui: null,
      activationCode: "HUM123",
    ...
    {
      deviceUid: "POWER_ETH_001",
      devEui: null,
      activationCode: "PWR123",
      name: "Power Meter 01",
      type: "Power Meter",
      model: "ETH-P1",
      connectionType: ConnectionType.WIRED,
    ...
    {
      deviceUid: "LPWAN_002",
      devEui: "70B3D57ED005A002",
      activationCode: "LP-05A002",
      name: "LoRa Humidity Sensor 02",
      type: "Humidity",
      model: "LORA-H1",
      connectionType: ConnectionType.LPWAN,
      networkType: NetworkType.LORAWAN,
    ...
    {
      deviceUid: "LPWAN_003",
      devEui: "70B3D57ED005A003",
      activationCode: "LP-05A003",
      name: "LoRa Soil Sensor 03",
      type: "Soil Sensor",
      model: "LORA-S1",
      connectionType: ConnectionType.LPWAN,
      networkType: NetworkType.LORAWAN,
      gatewayId: "GW-HANOI-02",
    },
  ] as const;
